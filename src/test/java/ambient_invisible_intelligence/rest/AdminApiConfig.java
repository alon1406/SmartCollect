...
public class AdminApiConfig {
	...
	public void setPort(int port) {
		this.baseUrl = "http://localhost:" + port + "/ambient-invisible-intelligence/admin";
	}

	@Bean
	public RestClientHttpServiceGroupConfigurer adminGroupConfigurer() {
		return groups -> {
			groups
				.filterByName("admin")
				.forEachClient(
